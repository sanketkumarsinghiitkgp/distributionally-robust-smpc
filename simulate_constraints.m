function [z_history,e_history, u_history, radii_history, eta_history] = simulate_constraints(A,B,K,z,v,e,mu,sigma,support_a,N,px)
    SIG = [sigma 0; 0 sigma];
    AA = [0 1; 1 0 ; 0 -1 ; -1 0];
