function [h1, h2] = plot_dir (vX, vY, displayName)
...
% make plot 
h1 = plot (vX, vY, '.-','DisplayName',displayName); hold on;
% add arrows 
%h2 = quiver (vXQ0,vYQ0, vPx, vPy, 0, 'r','DisplayName',strcat(displayName,' arrow')); grid on; hold off 
h2 = quiver (vXQ0,vYQ0, vPx, vPy, 0,'DisplayName',strcat(displayName,' arrow')); grid on; % I have modified this. 
